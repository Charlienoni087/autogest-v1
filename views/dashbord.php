...
<div class="container-fluid px-4 py-3">
    <h2 class="mb-4 text-secondary">Resumen Operativo</h2>

    <!-- Fichas de Resumen (Cards) adaptadas a tus nuevos módulos -->
    <div class="row g-3 mb-4">
        <!-- Tarjeta 1: Vehículos -->
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="card text-white h-100" style="background-color: #1e09df; border: none;">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card shadow-sm p-3 bg-white rounded">
                <div class="card-body">
                    <h5 class="card-title mb-3 text-center" style="color:  #1e09df;">Frecuencia de Salidas Semanales</h5>
    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-lg-8">
            <div class="card shadow-sm p-3 bg-white rounded h-100">
                <div class="card-body">
                    <h5 class="card-title mb-3" style="color: #110ec2; font-weight: bold;">Últimos Reportes de Circulación</h5>
                    <div class="table-responsive">
                        <table class="table align-middle table-hover" style="background-color: #E0F7FA;">
                            <thead style="background-color: #d1f3f7; color: #003598;">
                                <tr>
        ...
        <div class="col-12 col-lg-4">
            <div class="card shadow-sm p-3 bg-white rounded h-100">
                <div class="card-body">
                    <h5 class="card-title mb-3" style="color: #03389b; font-weight: bold;">Estatus de Vehículos</h5>
                    
                    <div class="p-2 mb-2 rounded" style="background-color: #5456ffc0;">
                        <span class="d-block font-weight-bold" style="color:  #1e09df; font-weight: bold;">Mantenimiento</span>
                        <small class="text-muted">Toyota Hilux - Placa M 2345</small>
                    </div>
                    <div class="p-2 mb-2 rounded" style="background-color: #052baa; color: white;">
